(() => {
    const cheat = (async () => {
        ...
        const guiWrapper = createElement("div", {
            ...
            (gui = createElement("div", {
                ...
                createElement("div", {
                    ...
                    innerHTML: "GitHub - BobReed24",
                    onclick: () => window.open("https://github.com/BobReed24", "_blank").focus()
                }),
        ...
        const Cheats = {
            global: [
                {
                    name: "Automaticly Answer Questions",
                    description: "Answers questions for you",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                },
                {
                    ...
                    description: "Shows you the answer",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                },
                {
                    ...
                    description: "Percent of Auto Answer of getting correct",
                    inputs: [
                        {
                            name: "Target Grade",
                            type: "number"
